            ...
            <div className="p-16 dc__gap-12 flexbox dc__content-end">
                {secondaryButtonConfig && (
                    <Button
                        ...
                        style={'style' in secondaryButtonConfig ? secondaryButtonConfig.style : ButtonStyleType.neutral}
                        disabled={secondaryButtonConfig.disabled}
                        text={secondaryButtonConfig.text}
                        onClick={secondaryButtonConfig.onClick as ButtonHTMLAttributes<HTMLButtonElement>['onClick']}
                ...
                {primaryButtonConfig && (
                    <Button
                        ...
                        disabled={
                            ('disabled' in primaryButtonConfig && primaryButtonConfig.disabled) || disablePrimaryButton
                        }
...
const ConfirmationModal = ({ buttonConfig, showConfirmationModal, handleClose, ...props }: ConfirmationModalProps) => {
    const { primaryButtonConfig, secondaryButtonConfig } = buttonConfig
        ...
        <AnimatePresence>
            {showConfirmationModal ? (
                <Backdrop onEscape={handleCloseWrapper}>
                    <ConfirmationModalBody buttonConfig={buttonConfig} {...props} />
                </Backdrop>
            ) : null}
        </AnimatePresence>
    )
