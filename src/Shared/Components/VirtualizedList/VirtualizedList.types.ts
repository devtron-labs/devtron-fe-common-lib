import { AutoSizedStickyTreeProps, StickyTreeRowRenderer, TreeNode } from 'react-virtualized-sticky-tree'
 ...
 */
export type VirtualizedListItem<ListKeys, ExtendedType = {}> = TreeNode &
    ExtendedType & {
