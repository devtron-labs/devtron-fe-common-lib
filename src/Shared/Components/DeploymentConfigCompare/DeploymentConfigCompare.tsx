...
import { getChartReferencesForAppAndEnv, getOptions } from './service'
import {
...
import { getSelectPickerOptionByValue, SelectPickerOptionType, SelectPickerVariantType } from '../SelectPicker'
import { APP_CONFIG_BASE_CONFIGURATIONS } from './constants'
...
export const DeploymentConfigCompare = ({
    ...
    const renderCompareEnvironmentSelectorProps = () => ({
        ...
        value: getSelectPickerOptionByValue(compareEnvironmentSelectorOptions, chartRefId || compareWith, {
            label: APP_CONFIG_BASE_CONFIGURATIONS.name,
            value: '',
        }),
    ...
    const deploymentConfigDiffSelectors: DeploymentConfigDiffProps['selectorsConfig'] = {
        ...
        secondaryConfig: [
            {
                id: compareTo || APP_CONFIG_BASE_CONFIGURATIONS.name,
                type: 'string',
                text: compareTo || APP_CONFIG_BASE_CONFIGURATIONS.name,
            },
    ...
    const getNavHelpText = (): DeploymentConfigDiffProps['navHelpText'] => {
        ...
        const compareWithText = `${chart ? `v${chart.chartVersion}(Default)` : compareWith || APP_CONFIG_BASE_CONFIGURATIONS.name}`
        const compareToText = compareTo || APP_CONFIG_BASE_CONFIGURATIONS.name
    ...
    return (
        <DeploymentConfigDiff
            ...
            navHeading={`Comparing ${compareTo || APP_CONFIG_BASE_CONFIGURATIONS.name}`}
